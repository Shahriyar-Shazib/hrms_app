...
class ApiConfig {
  ...
  static const String _releaseUrl = https://traditions-routine-amazing-cope.trycloudflare.com/api/v1';
  ...
  static const String _debugUrl = https://traditions-routine-amazing-cope.trycloudflare.com/api/v1';
